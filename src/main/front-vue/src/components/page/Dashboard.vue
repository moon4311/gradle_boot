        ...
        <el-row :gutter="20">
                ...
                <el-row>
                    <el-col>
                        <el-card shadow="hover" class="mgb20">
                            ...
                            <div class="user-info-list">마지막 로그인：<span>2018-01-01</span></div>
                            <div class="user-info-list">마지막 로그인 위치：<span>동관</span></div>
                        </el-card>
            ...
            <el-col :span="16">
                ...
                <el-card shadow="hover" :body-style="{ height: '304px'}">
                    <div slot="header" class="clearfix">
                        <span>TODO List</span>
                        <el-button style="float: right; padding: 3px 0" type="text">추가</el-button>
                    </div>
...
<script>
    export default {
        ...
        computed: {
            role() {
                return this.name === 'admin' ? '최고관리자' : '일반사용자';
            }
        }
    }
